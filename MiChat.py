...
st.set_page_config(page_title="ChatPerron", page_icon="🗿")
st.title("ChatPerron, inteligencia inhumana")

nombre = st.text_input("Cual es tu nombre?")
if st.button("Saludar!"):
    st.write(f"Hola {nombre}! Bienvenido a ChatPerron")

MODELOS = ['llama-3.1-8b-instant', 'llama-3.3-70b-versatile', 'deepseek-r1-distill-llama-70b']

def configurar_pagina():
    st.title("Mi Chat de IA - ChatPerron")
